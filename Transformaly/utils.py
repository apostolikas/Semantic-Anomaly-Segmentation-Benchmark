        ...
        for _class in _classes:
            ...
            for unimodal in unimodal_vals:
                ...
                assert dataset in ['cifar10', 'cifar100', 'fmnist', 'cats_vs_dogs',
                                   'dior', 'pvoc', 'coco'], f"{dataset} not supported yet!"
                if unimodal:
                ...
                if unimodal:
                    anomaly_classes = [i for i in range(_classes) if i != _class]
                else:
                ...
                if dataset == 'coco':
                    ...
                    trainsetLoader = mod.get_train_loader()
                    testsetLoader = mod.get_test_loader()
