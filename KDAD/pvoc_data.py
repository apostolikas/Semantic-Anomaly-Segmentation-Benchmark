...
class PascalVOCDataModule():
    ...
    def __init__(self, batch_size, normal_classes, train_transform, val_transform, test_transform,  img_dir="./VOCSegmentation", num_workers=2) -> None:
        super().__init__()
    ...
    def get_val_dataloader(self, batch_size=None):
        batch_size = self.batch_size if batch_size is None else batch_size
        return DataLoader(self.val_dataset, batch_size=16, shuffle=False, num_workers=self.num_workers, pin_memory=True)
