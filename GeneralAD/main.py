...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", default="cifar10", choices=['pvoc', 'coco', 'cifar10', 'mvtec-loco-ad', 'mvtec-ad', 'fgvc-aircraft', 'cifar100', 'stanford-cars', 'fmnist', 'catsvdogs', 'view', 'mpdd', 'visa'], help="Name of the dataset")
